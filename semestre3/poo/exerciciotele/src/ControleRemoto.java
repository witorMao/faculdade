...
public class ControleRemoto {
	...
	public void diminuiVolume() {
		...
		if(this.tv.getVolume() > 0) this.tv.setVolume(this.tv.getVolume() - 1);
		else this.tv.setVolume(0);
	}
	...
	public void diminuiCanal() {
		...
		if(this.tv.getCanal() > 0) this.tv.setCanal(this.tv.getCanal() - 1);
		else this.tv.setCanal(0);
	}
