/**
 * Classe genérica que representa objeto nó utilizado na criação da classe que representa a estrutura de dados lista ligada, desenvolvida com a aplicação de Generics em Java, como exercício da aula de POO.
