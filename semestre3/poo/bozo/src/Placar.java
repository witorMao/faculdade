...
public class Placar {
			...
			switch(posicao) {
				...
				case 9:
					...
					if(this.score[posicao] != -1) throw new IllegalArgumentException("Essa posição do placar já esta ocupada\n");
						...
						//caso tenha uma qudra ou quina atribui 30 pontos na posição
						if(cont_1 >= 4 || cont_2 >= 4 || cont_3 >= 4 || cont_4 >= 4 || cont_5 >= 4 || cont_6 >= 4) this.score[posicao] = 30;
						else this.score[posicao] = 0;//se não tiver atribui 0
					}
					break;
				case 10:
					//verifica se a posição já foi ocupada
	...
	public int getScore() {
		int aux = 0;
		//parte de 1 pois a posição 0 do vetor não é utilizada
